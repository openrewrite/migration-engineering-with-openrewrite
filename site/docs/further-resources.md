...
- [Spring Boot 4 migration guide](https://github.com/spring-projects/spring-boot/wiki/Spring-Boot-4.0-Migration-Guide): Reference to upgrading to Spring Boot 4.
...
- [Fundamentals of recipe development workshop](https://docs.moderne.io/hands-on-learning/fundamentals): Learn how OpenRewrite works and get hands-on experience developing recipes.
...
## Contribute
- [Contribute to OpenRewrite](https://github.com/openrewrite/.github/blob/main/CONTRIBUTING.md): Guide on how to contribute to the OpenRewrite project.
